...
1,2M in total. Its own checks: Приёмка: 329 проверок, отказов 0, пропущено 1 (нужен каталог разработки).
...
Всего 1,2M. Его собственная приёмка: Приёмка: 329 проверок, отказов 0, пропущено 1 (нужен каталог разработки).
